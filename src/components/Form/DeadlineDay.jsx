...
function DeadlineDay ({ value, handleUpdate }) {
    ...
    return (
        <div className={`flex flex-col w-full border-2 p-1 rounded-2xl 
            ...
            <ol className='flex gap-x-1 justify-center'>
                {days.map((day, index) => 
                    <li key={index} data-value={day.id} 
                        ...
                        className={`grid rounded-full p-1 w-10 h-9 place-items-center cursor-pointer select-none text-xs 
