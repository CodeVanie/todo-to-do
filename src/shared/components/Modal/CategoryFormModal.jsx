...
export default function CategoryFormModal({ isOpen, onClose }) {
    ...
    function handleAddCategoryButton() {
        setCategories((prev) => [...prev, {id: `c_${categories.length}`, label: newCategory}]);
        onClose();
    }
        ...
        <ModalBackground isOpen={isOpen} onAnimationEnd={onAnimationEnd}>
            <SmallModalWrapper isOpen={isOpen}>
                ...
                <div className="flex flex-col w-full gap-y-3 mt-3 font-bold text-red-950">
                    ...
                    placeholder='Add a category name...' type="text" onChange={(e) => setNewCategory(e.target.value)} required/>
